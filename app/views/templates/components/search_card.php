...
<div class="card rounded border-0 overflow-hidden" style="background-color: var(--text-disabled); cursor: pointer; border-radius: 10px !important; flex: 1; text-align: start;">

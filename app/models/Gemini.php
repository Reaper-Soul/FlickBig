  ...
  public function generateTrendingMovies(){
    ...
    public function generateReview($movieTitle){
        $data = [
            "contents" => [[
                "parts" => [[
                    "text" => "Note: The review should be in a single line and there should not be any additional formatting. Give me a review for the movie" . htmlspecialchars($movieTitle) . "Make it feel like a real human write it. You are free to use slangs, emojis and anything else that's trendy to express your emotions. Make sure that the review is not more than 50 words. Also, you are free to critize the movie, just don't use any rude or offensive language."
                ]]
            ]]
        ];
